...
function ciniki_conferences_conferenceScheduleDownload($ciniki) {
    ...
    if( $rc['stat'] != 'ok' ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.conferences.20', 'msg'=>'Conference not found', 'err'=>$rc['err']));
    }
    if( !isset($rc['conference']) ) {
        return array('stat'=>'fail', 'err'=>array('code'=>'ciniki.conferences.21', 'msg'=>'Unable to find Conference'));
    }
