...
function ciniki_conferences_settingsUpdate(&$ciniki) {
    ...
    $rc = ciniki_conferences_checkAccess($ciniki, $args['tnid'], 'ciniki.conferences.settingsUpdate'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    $rc = ciniki_core_dbDetailsQuery($ciniki, 'ciniki_conferences_settings', 'tnid', $args['tnid'], 'ciniki.conferences', 'settings', '');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    foreach($changelog_fields as $field) {
        if( isset($ciniki['request']['args'][$field]) 
            ...
            $strsql = "INSERT INTO ciniki_conferences_settings (tnid, detail_key, detail_value, date_added, last_updated) "
            ...
            ciniki_core_dbAddModuleHistory($ciniki, 'ciniki.conferences', 'ciniki_conferences_history', $args['tnid'], 
