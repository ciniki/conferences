...
function ciniki_conferences_CFPLogUpdate(&$ciniki) {
    ...
    $rc = ciniki_conferences_checkAccess($ciniki, $args['tnid'], 'ciniki.conferences.CFPLogUpdate');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    $rc = ciniki_core_objectUpdate($ciniki, $args['tnid'], 'ciniki.conferences.cfplog', $args['cfplog_id'], $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
