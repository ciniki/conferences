...
// Description
// -----------
// This method will turn the conferences settings for a business.
//
// Arguments
// ---------
// api_key:
...
// -------
//
function ciniki_conferences_settingsGet($ciniki) {
    //  
    ...
    $rc = ciniki_conferences_checkAccess($ciniki, $args['business_id'], 'ciniki.conferences.settingsGet'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }
	$modules = $rc['modules'];
