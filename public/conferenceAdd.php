...
// Description
// -----------
// This method will add a new conference for the business.
//
// Arguments
// ---------
// api_key:
// auth_token:
// business_id:        The ID of the business to add the Conference to.
//
// Returns
// -------
// <rsp stat="ok" id="42">
...
function ciniki_conferences_conferenceAdd(&$ciniki) {
    ...
    $rc = ciniki_core_objectAdd($ciniki, $args['business_id'], 'ciniki.conferences.conference', $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
